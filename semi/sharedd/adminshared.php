...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="../admin/descadmin.php"> Admins Profile <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
 ...
 <form action="">
      <button name="logout" class="btn"><i style='font-size:24px' class='fas'>&#xf52b;</i> 
        </button>
     </form>   
</nav>
